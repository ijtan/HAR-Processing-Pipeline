...
As carried out in [https://www.sciencedirect.com/science/article/abs/pii/S1574119216302280] a sliding window of size 128 with a stride of 64 was adopted, which in simpler terms means grouping 128 entries (2.56 seconds of data) for each window, and overlap each window by 1.28 seconds.\\
